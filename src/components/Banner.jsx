...
const Banner = () => {
    return (
       <div className='bg-light'>
         <div className='container d-md-flex gap-5'>
         
            <img className='rounded-1 w-100' src="https://img.freepik.com/premium-photo/mutton-biryani-food-photography_162831-2.jpg?size=626&ext=jpg" alt="" />
            <div>
